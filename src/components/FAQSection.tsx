...
const faqData: FAQItem[] = [
  ...
  },
  {
    ...
    answer: "У нас есть бесплатная версия для небольших команд до 3 человек. Для продуктовых команд — 990₽/месяц за пользователя. Для корпораций действуют индивидуальные тарифы с техподдержкой и персональной настройкой."
  },
  {
    question: "Можно ли перенести данные из других систем?",
    answer: "Да, мы помогаем с миграцией данных из других систем управления знаниями. Для корпоративных клиентов предоставляем персональную поддержку по переносу документации, настройке структуры и обучению команды."
  },
  {
  ...
  {
    question: "Что даёт объединение документов и досок?",
    answer: "Вся информация проекта находится в одном месте: текстовая документация, визуальные схемы, roadmap и User Flow. Команде не нужно переключаться между разными инструментами, а новые сотрудники быстрее входят в контекст."
  }
];
